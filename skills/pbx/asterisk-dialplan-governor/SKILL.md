# Asterisk Dialplan Governor

Design and review dialplan, Caller ID, LCR, failover, normalization, recording, spying, whispering and call-routing behavior with controlled change boundaries.
