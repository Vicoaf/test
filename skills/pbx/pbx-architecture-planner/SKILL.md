# PBX Architecture Planner

Design FreePBX, Asterisk, PJSIP, SIP, RTP, network, transport, endpoint, trunk and deployment architecture with explicit dependencies and acceptance criteria.
