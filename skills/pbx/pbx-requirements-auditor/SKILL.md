# PBX Requirements Auditor

Audit PBX topology, call flows, extensions, trunks, carriers, routing, security, CRM integration, QoS, recording, monitoring and operational requirements before implementation.
